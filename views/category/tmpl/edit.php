    ...
    <div id="j-main-container"  <?php if(!empty($this->sideBar)){ echo 'class="span10"'; }?> >
        ...
        <div class="panel" >
            ...
            <div class="control-group">
                ...
                <div class="controls" ><?php echo $this->helper->multiLanguageInputField('name', true, $this->context->controller->category->name); ?></div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls" ><?php echo $this->helper->multiLanguageTextAreaField('description', $this->context->controller->category->description); ?></div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls" ><?php echo $this->helper->multiLanguageInputField('meta_title', true, $this->context->controller->category->meta_title); ?></div>
            </div>
            <div class="control-group">
                ...
                <div class="controls" ><?php echo $this->helper->multiLanguageInputField('meta_description', true, $this->context->controller->category->meta_description); ?></div>
            </div>
            <div class="control-group">
                ...
                <div class="controls" ><?php echo $this->helper->multiLanguageInputField('meta_keywords', true, $this->context->controller->category->meta_keywords); ?></div>
            </div>
            <div class="control-group">
                ...
                <div class="controls" ><?php echo $this->helper->multiLanguageInputField('link_rewrite', true, $this->context->controller->category->link_rewrite); ?></div>
            </div>
